...
from ns_extract.pipelines import WordCountExtractor, ParticipantDemographicsExtractor, TaskExtractor
...
def run_cli(args):
    ...
    with patch('sys.stdout', stdout), patch('sys.stderr', stderr), \
         patch('sys.argv', ['ns_extract'] + args):
        try:
            main()
