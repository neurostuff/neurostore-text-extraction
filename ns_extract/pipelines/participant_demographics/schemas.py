...
class GroupBase(BaseModel):
    ...
    age_mean: Optional[float] = Field(
        default=None, description="Mean age of participants in this group"
    )
    ...
    age_minimum: Optional[int] = Field(
        default=None, description="Minimum age of participants in this group"
    )
    age_maximum: Optional[int] = Field(
        default=None, description="Maximum age of participants in this group"
    )
    age_median: Optional[int] = Field(
        default=None, description="Median age of participants in this group"
    )
