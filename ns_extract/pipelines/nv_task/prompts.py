...
Your task is to identify information about the design of the fMRI task
and analysis of the neuroimaging data.
If any information is missing or not explicitly stated in the text, return `null` for that field.

For any extracted text, maintain fidelity to the source.
Avoid inferring information not explicitly stated.
If a field cannot be completed, return `null`.
